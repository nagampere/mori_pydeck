...
name_file = basedir + 'ua_names_2020_M.csv'
pop_file = basedir + 'mesh3_pop_1970-2200.csv'

mesh_file = uadir + 'mesh3/mesh3_on_contiguous_EPSG4326_WGS84.geojson'
ua_file = mapdir + 'ua_1000_minpop_10000_1970-2200.shp'
coast_file = uadir + 'coast_EPSG4326_WGS84.geojson'

cell_file = basedir + 'ua_cells_prediction_1970-2200.csv'
# outfig = outdir + 'fig_cities_' + pred_type + '_min-pop_' +\
# str(min_pop)+ '_wo_map_' +  str(year) + '.html'
outfig = outdir + 'fig_tenjin-density_radius-' + str(radius) + 'm_in_ua_' + str(ua) + '_base-year_' + str(base_year) + '_' + ver + '_' +  pred_type + '_bgcolor_' + background + '_' + str(year) + '.html'

outpng = outdir + 'fig_tenjin-density_' + pred_type + '_min-pop_' +\
str(min_pop)+ '_wo_map_' +  str(year) + '.png'
